...
public class ServerConfig {
  ...
  public ServerConfig(String name, ServerType type, String launchFile,
      String launchOptions, boolean overwrite, boolean skiplaunch, LaunchType launchType,
      JsonObject json) {
    this.name = name;
    this.type = type;
  ...
  public ServerConfig(JsonObject jsonObject) {
    this(jsonObject.get("templateName").getAsString(),
        ...
        jsonObject.has("launchType") ? LaunchType
            .valueOf(jsonObject.get("launchType").getAsString().toUpperCase()) : LaunchType.PROCESS,
        jsonObject);
  }
