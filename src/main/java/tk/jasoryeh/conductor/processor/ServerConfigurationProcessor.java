...
public abstract class ServerConfigurationProcessor {
   ...
   * @return Success/fail
   */
  public abstract boolean processTree(final JsonObject jsonObject, ServerConfig conf,
      String parents,
   ...
   * @return Success/fail
   */
  public abstract boolean processObject(String fileName, JsonObject obj, ServerConfig conf,
      String parents,
      boolean recursive, Map<String, String> vars, boolean isInclude);
}
