...
public class JenkinsDownloader extends Downloader {
  ...
  public JenkinsDownloader(JenkinsConfiguration authentication, String job, String artifact,
      int num,
   ...
   */
  public JenkinsDownloader(String host, String job, String artifactName, int number,
      String username,
  ...
  public boolean download() {
    ...
    List<Artifact> artifacts =
        number == -1 ? details.getLastSuccessfulBuild().details().getArtifacts()
    ...
    for (Artifact artifact : artifacts) {
      ...
      if (artifact.getFileName().equalsIgnoreCase(this.artifactName)) {
        ...
        Build acceptedBuild =
            number == -1 ? details.getLastSuccessfulBuild() : details.getBuildByNumber(number);
    ...
    this.log("Unable to find the artifact/build | " + this.job + " | " + this.artifactName + " #"
        + this.number);
    return false;
  }
