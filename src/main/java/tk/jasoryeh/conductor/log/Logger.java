...
public class Logger {
   ...
   */
  private final static String INFOPREFIX =
      TerminalColors.RESET + "" + TerminalColors.WHITE + "[" + TerminalColors.GREEN + "INFO"
          + TerminalColors.WHITE + "]" + TerminalColors.RESET;
  private final static String WARNPREFIX =
      TerminalColors.RESET + "" + TerminalColors.WHITE + "[" + TerminalColors.YELLOW + "WARN"
          + TerminalColors.WHITE + "]" + TerminalColors.RESET;
  private final static String ERRORPREFIX =
      TerminalColors.RESET + "" + TerminalColors.WHITE + "[" + TerminalColors.RED + "ERROR"
          + TerminalColors.WHITE + "]" + TerminalColors.RESET;
  private final static String DEBUGPREFIX =
      TerminalColors.RESET + "" + TerminalColors.WHITE + "[" + TerminalColors.CYAN_BOLD + "DEBUG"
          + TerminalColors.WHITE + "]" + TerminalColors.RESET;
  ...
  protected String getMessage(String prefix, Object... objects) {
    ...
    return TerminalColors.RESET + "" + TerminalColors.WHITE + logDate() + " " + prefix + " "
